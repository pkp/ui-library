...
<Meta title="mixins/dialog" />

## Usage

**Mixins are [deprecated](../?path=/docs/guide-technical-roadmap--docs#vue3-composition-api-35) in favour of composables. Composable [useDialog](../?path=/docs/composables-usedialog--docs) is available instead.**
