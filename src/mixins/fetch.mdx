...
<Meta title="Mixins/fetch" />

# Usage

**Mixins are [deprecated](../?path=/docs/guide-technical-roadmap--docs#vue3-composition-api-35) in favour of composables, for paginated fetch check out [useFetchPaginated](../?path=/docs/composables-usefetchpaginated--docs).**
