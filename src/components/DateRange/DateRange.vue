<template>
	<div class="pkpDateRange">
		...
		<div v-if="options && this.isOpen" class="pkpDateRange__options">
			...
			<form class="pkpDateRange__optionGroup pkpDateRange__form" @submit="applyCustomRange">
...
export default {
	...
	methods: {
		 ...
		 * @param string dateEnd
		 */
		selectOption: function (dateStart, dateEnd) {
		 ...
		 * @return boolean
		 */
		validateDateExists: function (date) {
