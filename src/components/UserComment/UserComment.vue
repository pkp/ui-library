			...
			<ul>
				...
				>
					<div class="flex justify-between gap-4">
						...
						<!-- Any user(logged in or not), except the creator of the comment, can see option to report comment -->
						<PkpButton
...
// Fetch comments after a short delay to ensure `pkp` global var and vue composables are loaded before use
onMounted(() => {
	setTimeout(async () => {
