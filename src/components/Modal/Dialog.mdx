...
The dialog prop actions (e.g., an array[] of buttons like "OK" and "Cancel") can be overridden by passing a component to `bodyComponent` that uses the `PkpDialogBody` wrapper.
