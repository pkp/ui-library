...
The main view groups reviews by publication version (round). The component uses BEM-style CSS class naming and renders through nested accordion primitives. Comments mark which sections appear in each state.
				...
				<div class="PkpAccordionItem PkpOpenReviewByRound__roundItem">
								...
								<span class="PkpOpenReviewByRound__roundHeader">
									...
									<span class="PkpOpenReviewByRound__roundSummary">
										...
										>
											...
											<span
												class="PkpOpenReviewByRound__roundSummarySeparator"
												aria-hidden="true"
											>
												–
											</span>
					...
					<div class="PkpAccordionContent PkpOpenReviewByRound__roundContent">
						<div class="PkpAccordionRoot">
							...
							<div
								class="PkpAccordionItem PkpOpenReviewItemByRound"
								data-review-id="42"
							>
								<h4 class="PkpAccordionHeader">
									<button class="PkpAccordionHeader__trigger">
										<span class="PkpAccordionHeader__content">
											<!-- slot: reviewHeader -->
											<span class="PkpOpenReviewItemByRound__header">
												<span
													class="PkpOpenReviewItemByRound__status"
													data-recommendation="approved"
												>
													<svg
														class="PkpIcon PkpOpenReviewItemByRound__statusIcon"
													></svg>
													<span class="PkpOpenReviewItemByRound__statusText">
														Accept Submission
													</span>
												</span>
												<span class="PkpOpenReviewItemByRound__reviewer">
													Dr. Jane Smith
												</span>
												<span class="PkpOpenReviewItemByRound__affiliation">
													University of Barcelona
												</span>
												<!-- Shown when dateCompleted exists -->
												<span class="PkpOpenReviewItemByRound__date">
													Jan 15, 2025
												</span>
											</span>
										</span>
...
<div class="PkpAccordionRoot PkpOpenReviewByReviewer">
	<div class="PkpAccordionItem PkpOpenReviewByReviewer__reviewerItem">
		...
		<div class="PkpAccordionContent PkpOpenReviewByReviewer__reviewerContent">
			<div class="PkpAccordionRoot">
				<!-- Review items — PkpOpenReviewItemByReviewer with version/date -->
				<div
					class="PkpAccordionItem PkpOpenReviewItemByReviewer"
					data-review-id="42"
				>
					<h4 class="PkpAccordionHeader">
						<button class="PkpAccordionHeader__trigger">
							<span class="PkpAccordionHeader__content">
								<!-- slot: reviewHeader -->
								<span class="PkpOpenReviewItemByReviewer__header">
									<span
										class="PkpOpenReviewItemByReviewer__status"
										data-recommendation="approved"
									>
										<svg
											class="PkpIcon PkpOpenReviewItemByReviewer__statusIcon"
										></svg>
										<span class="PkpOpenReviewItemByReviewer__statusText">
											Accept Submission
										</span>
									</span>
									<span class="PkpOpenReviewItemByReviewer__version">
										Version 2 of Record
									</span>
									<span class="PkpOpenReviewItemByReviewer__date">
										Jan 15, 2025
									</span>
								</span>
							</span>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<code>{'{ roundId, authorResponse }'}</code>
			</td>
