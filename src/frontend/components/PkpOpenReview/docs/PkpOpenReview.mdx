						...
						<button class="PkpAccordionHeader__trigger">
							<span class="PkpAccordionHeader__content">
								...
								<span class="PkpOpenReviewByRound__roundHeader">
									<span class="PkpOpenReviewByRound__roundInfo">
									...
									<button class="PkpAccordionHeader__trigger">
										<span class="PkpAccordionHeader__content">
											...
											<span class="PkpOpenReviewItemByRound__header">
												<span class="PkpOpenReviewItemByRound__info">
													<span
												...
												<span class="PkpOpenReviewItemByRound__meta">
						...
						<button class="PkpAccordionHeader__trigger">
							<span class="PkpAccordionHeader__content">
								...
								<span class="PkpOpenReviewItemByReviewer__header">
									<span class="PkpOpenReviewItemByReviewer__info">
										<span
										...
										<!-- version instead of reviewer + affiliation -->
										<span class="PkpOpenReviewItemByReviewer__version">
											Version 2 of Record
										</span>
									</span>
									<span class="PkpOpenReviewItemByReviewer__meta">
