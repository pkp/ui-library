...
<section class="PkpOpenReviewSummary">
	...
	<div class="PkpOpenReviewSummary__statusSection">
		<h3 class="PkpOpenReviewSummary__sectionLabel">STATUS:</h3>
		<p class="PkpOpenReviewSummary__sectionValue">
			In progress since Dec 12, 2025
		</p>
	</div>

	<div class="PkpOpenReviewSummary__currentVersionSection">
		<h3 class="PkpOpenReviewSummary__sectionLabel">CURRENT VERSION:</h3>
		<p class="PkpOpenReviewSummary__sectionValue">
			Version of Record 2 (November, 2025)
		</p>
	</div>

	<!-- Bordered box with reviewer stats -->
	<div class="PkpOpenReviewSummary__reviewerBox">
		<h3 class="PkpOpenReviewSummary__reviewerBoxHeading">
	...
	<div class="PkpAccordionRoot PkpOpenReviewSummary__accordion">
		<div class="PkpAccordionItem">
			...
			<div class="PkpAccordionContent">
				<div class="PkpOpenReviewSummary__accordionBody">
...
- **Dash separator**: `aria-hidden="true"` so screen readers skip the visual dash between label and count.
