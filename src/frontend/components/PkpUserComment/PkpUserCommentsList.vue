				...
				>
					<div class="pkpUserCommentsList__item--content">
						...
						<div class="pkpUserCommentsList__item--author">
							<PkpAvatarInitials
								:initials="comment.userDisplayInitials"
								:shrink="true"
							/>
...
const props = defineProps({
	...
	/** Total number of comments for this publication version*/
...
/**
 * Action to be performed after a comment is saved.
 * @param data - The saved comment data.
 */
