...
import PkpOpenReviews from '../PkpOpenReviews.vue';
import {
...
export default {
	title: 'Frontend/PkpOpenReviews/Full View',
	component: PkpOpenReviews,
	render: (args) => ({
		components: {PkpOpenReviews},
		setup() {
			return {args};
		},
		template: '<PkpOpenReviews v-bind="args"></PkpOpenReviews>',
	}),
};
...
const tailwindStyles = {
	...
	PkpOpenReviewsAuthorResponseDetails: {
	...
	PkpOpenReviewsAuthorResponseContent: {
