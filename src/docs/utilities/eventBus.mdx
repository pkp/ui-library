...
<Meta title="Utilities/Event Bus" />

# Event Bus

**Deprecated. For new pages, where the pinia store is being used, we believe that pinia store provides enough [capability](../?path=/docs/guide-pinia-store--docs#component-pinia-store) to replace need for global event bus.**
