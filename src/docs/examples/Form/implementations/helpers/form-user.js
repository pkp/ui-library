...
export default {
	...
	errors: {
		...
		newPassword: ['Your password must be at least six characters long.'],
		bio: {fr_CA: ['Please provide a bio statement to accompany your publication.']},
		country: ['Please select your country.'],
		'mailing-address': ['You must enter a mailing address where you can receive post.'],
	},
};
