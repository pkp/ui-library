	...
	views: [
		{
			...
			count: 0,
			op: 'assigned',
			queryParams: {status: [1], assignedWithRoles: [1, 16, 17, 4097]},
		},
		{
			id: 'active',
			name: 'Active submissions',
			count: 0,
			queryParams: {status: [1], assignedWithRoles: null},
		},
		{
			id: 'needs-editor',
			name: 'Needs editor',
			count: 0,
			queryParams: {isUnassigned: true, status: [1]},
		},
		{
			id: 'initial-review',
			name: 'All in submission stage',
			count: 0,
			queryParams: {stageIds: [1], status: [1], assignedWithRoles: null},
		},
		{
			id: 'needs-reviews',
			name: 'Needs reviews',
			count: 0,
			op: 'reviews',
			queryParams: {needsReviews: true, assignedWithRoles: null},
		},
		{
			id: 'awaiting-reviews',
			...
			count: 0,
			op: 'reviews',
			queryParams: {awaitingReviews: true, assignedWithRoles: null},
		},
		{
			...
			count: 0,
			op: 'reviews',
			queryParams: {reviewsSubmitted: true, assignedWithRoles: null},
		},
		{
			id: 'reviews-overdue',
			...
			count: 0,
			op: 'reviews',
			queryParams: {reviewsOverdue: true, assignedWithRoles: null},
		},
		{
			id: 'revisions-submitted',
			name: 'Author revisions submitted',
			count: 0,
			op: 'reviews',
			queryParams: {revisionsSubmitted: true, assignedWithRoles: null},
		},
		{
			id: 'external-review',
			name: 'All in review stage',
			count: 0,
			queryParams: {stageIds: [3], status: [1], assignedWithRoles: null},
		},
		{
			id: 'copyediting',
			name: 'All in copyediting stage',
			count: 0,
			queryParams: {stageIds: [4], status: [1], assignedWithRoles: null},
		},
		{
			id: 'production',
			name: 'All in production stage',
			count: 0,
			queryParams: {stageIds: [5], status: [1], assignedWithRoles: null},
		},
		{
			id: 'scheduled',
			name: 'Scheduled for publication',
			count: 0,
			queryParams: {status: [5], assignedWithRoles: null},
		},
		{
			id: 'published',
			name: 'Published',
			count: 0,
			queryParams: {status: [3], assignedWithRoles: null},
		},
		{
			id: 'declined',
			name: 'Declined',
