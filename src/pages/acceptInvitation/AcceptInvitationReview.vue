	...
	<div v-for="review in store.steps" :key="review.id">
		...
		>
			<template v-if="review.id === 'userDetails'">
				...
				<div v-for="(section, index) in review.sections" :key="index">
					<div
						v-if="section.id === 'userCreateDetailsForm'"
						class="submissionWizard__reviewPanel__item"
					>
						...
						<div class="submissionWizard__reviewPanel__item__value">
							<template v-for="field in section.form.fields" :key="field.name">
								{{
									field.name === 'orcid'
										? field.value
											? field.value
						...
						<template v-if="section.form.errors.givenName">
							<notification
								v-for="(error, i) in section.form.errors.givenName"
								:key="i"
								type="warning"
							>
						...
						<template v-if="section.form.errors.familyName">
							<notification
								v-for="(error, i) in section.form.errors.familyName"
								:key="i"
								type="warning"
							>
								<icon icon="exclamation-triangle"></icon>
						...
						<template v-if="section.form.errors.affiliation">
							<notification
								v-for="(error, i) in section.form.errors.affiliation"
								:key="i"
								type="warning"
							>
								<icon icon="exclamation-triangle"></icon>
						...
						<template v-if="section.form.errors.country">
							<notification
								v-for="(error, i) in section.form.errors.country"
								:key="i"
								type="warning"
							>
								<icon icon="exclamation-triangle"></icon>
