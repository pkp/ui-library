...
import AcceptInvitationCreateUserForms from './AcceptInvitationCreateUserForms.vue';
import AcceptInvitationCreateUserAccount from './AcceptInvitationCreateUserAccount.vue';
...
const props = defineProps({
	...
	/** API url accept invitation */
	acceptInvitationApiUrl: {
		type: String,
		required: false,
		default: null,
	},
	/** API url create/update user */
	userApiUrl: {
		type: String,
		required: false,
		default: null,
	...
	/** csrf token for accept invitation post request */
	csrfToken: {
		type: String,
		required: true,
	},
...
const acceptInvitationComponents = {
	AcceptInvitationCreateUserForms,
	AcceptInvitationCreateUserAccount,
