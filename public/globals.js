...
window.pkp = {
	...
	localeKeys: {
		...
		'submission.funders.description': 'This table allows users to add formal funding information, ensuring funders are properly credited and appear in the publication metadata.',
		'submission.funders.action.addFunder': 'Add a new Funder',
