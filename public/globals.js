...
window.pkp = {
	...
	const: {
		...
		// log event type for task/discussion notes
		SUBMISSION_LOG_TASK_NOTE_POSTED: 1342177285,
		...
		REVIEW_FORM_ELEMENT_TYPE_SMALL_TEXT_FIELD: 1,
		REVIEW_FORM_ELEMENT_TYPE_TEXT_FIELD: 2,
		REVIEW_FORM_ELEMENT_TYPE_TEXTAREA: 3,
		REVIEW_FORM_ELEMENT_TYPE_CHECKBOXES: 4,
		REVIEW_FORM_ELEMENT_TYPE_RADIO_BUTTONS: 5,
		REVIEW_FORM_ELEMENT_TYPE_DROP_DOWN_BOX: 6,
	...
	localeKeys: {
		...
		'openReview.hideReview': 'Hide Review',
		'openReview.reviewDate': 'Review Date: {$date}',
		'openReview.roundNumber': 'Round {$number}',
		...
		'submission.dataCitations.action.addDataCitation': 'Add Data Citation',
		...
		'submission.funders.required': 'Funders are required.',
